...
clawback 与 GIS；DC 计划和 LIRA 请按账户余额填入）、**FHSA** 夫妻合并单桶（供款
...
- **雇主养老金**——可选、每位配偶一份：填 pension statement 上的终身年领取额
  ...
  计划或 LIRA？把余额填进 RRSP/RRIF 栏即可，投影方式相同。
...
- FHSA 的供款抵税不建模成一笔单独的退税回流，和上面"RRSP 退税不会自动回流"
  一致；HBP（购房计划）也未建模——FHSA 已经覆盖了大部分首付需求，再叠加追踪
  15 年 HBP 还款计划的复杂度换不来多少精度。计划购买的首付永远按
